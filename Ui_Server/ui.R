    ...
    div(class = "MainTable",
        table(
            tr(th(""),
               ...
               td("% purity")),
            tr(th("Carbon"),
               td(numInput("carbon", 17, 4000)),
               td(numInput("carbon1", 0, 100)),
               td(numInput("carbon2", 100, 100, step = 0.1))),
            tr(th("Hydrogen"),
               td(numInput("hydrogen", 30, 8000)),
               td(numInput("hydrogen1", 0, 100)),
               td(numInput("hydrogen2", 100, 100, step = 0.1))),
            tr(th("Nitrogen"),
               td(numInput("nitrogen", 1, 4000)),
               td(numInput("nitrogen1", 0, 100)),
               td(numInput("nitrogen2", 100, 100, step = 0.1))),
            tr(th("Oxygen"),
               td(numInput("oxygen", 2, 4000)),
               td(""),
               td("")),
            tr(th("Silicon"),
               td(numInput("silicon", 2, 50)),
               td(""),
               td("")),
            tr(th("Iron"),
               td(numInput("iron", 0, 10)),
               td(""),
               td("")),
            tr(th("Sulfur"),
               td(numInput("sulfur", 0, 100)),
               td(""),
               td(""))
        )
    )
